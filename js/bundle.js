(() => {
  ...
  __publicField(ThemeManager, "THEME_KEY", "meyar_theme");
  ...
  var translations = {
    ar: {
      ...
      "common.all_rights": "\u062C\u0645\u064A\u0639 \u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \xA9 \u0645\u0639\u064A\u0627\u0631 \u0644\u0644\u0637\u0647\u064A",
      "common.view": "\u0639\u0631\u0636",
    ...
    en: {
      ...
      "common.all_rights": "All Rights Reserved \xA9 Meyar Culinary",
      "common.view": "View",
  ...
  var I18n = class {
    ...
    static t(key, params = {}) {
      ...
      let text = dict[key] !== void 0 ? dict[key] : fallbackDict[key] !== void 0 ? fallbackDict[key] : key;
    ...
    static translatePage(root = typeof document !== "undefined" ? document : null) {
      ...
      const resolveTranslation = (k) => {
        return dict[k] !== void 0 ? dict[k] : fallbackDict[k] !== void 0 ? fallbackDict[k] : null;
      };
  ...
  __publicField(I18n, "LANG_KEY", "meyar_lang");
  ...
  __publicField(Modal, "activeModal", null);
  ...
  function normalizeSearchQuery(str) {
    if (!str) return "";
    return String(str).toLowerCase().normalize("NFD").replace(/[\u064B-\u065F\u0670]/g, "").replace(/[أإآٱ]/g, "\u0627").replace(/ة/g, "\u0647").replace(/ى/g, "\u064A").trim();
  }
  ...
  var FeedPage = class {
    ...
    `;
      stories.forEach((story) => {
        ...
        const ringClass = story.unviewed ? "border-2 border-brand-gold ring-2 ring-brand-gold/30" : "border border-border-subtle";
        html += `
  ...
  var ExplorePage = class {
    ...
    static shareItem(type, id, title = "") {
      ...
      if (typeof navigator !== "undefined" && navigator.clipboard && navigator.clipboard.writeText) {
        navigator.clipboard.writeText(url).then(() => Toast.success(I18n.t("toast.copied_success"))).catch(() => Toast.info(url));
      } else {
        Toast.success(I18n.t("toast.copied_success"));
      }
    }
  ...
  var RecipeScaler = class {
    ...
    init(baseServings, ingredients) {
      if (baseServings !== void 0 && baseServings !== null) {
        this.baseServings = Math.max(1, Number(baseServings) || 4);
        this.currentServings = this.baseServings;
      }
      if (ingredients !== void 0 && ingredients !== null) {
        this.ingredients = Array.isArray(ingredients) ? JSON.parse(JSON.stringify(ingredients)) : [];
      }
     ...
     */
    formatQuantity(val) {
      if (val === null || val === void 0 || isNaN(val)) return "";
      if (val <= 0) return "0";
      if (Math.abs(val - Math.round(val)) < 1e-4) {
        return Math.round(val).toString();
      }
      const fractions = [
        { dec: 0.25, frac: "\xBC", tol: 0.035 },
        { dec: 0.333, frac: "\u2153", tol: 0.035 },
        { dec: 0.5, frac: "\xBD", tol: 0.035 },
        { dec: 0.667, frac: "\u2154", tol: 0.035 },
        { dec: 0.75, frac: "\xBE", tol: 0.035 },
  ...
  var RecipePage = class {
    ...
    static updateTimerDisplay(stepNumber) {
      ...
      if (toggleBtn && toggleText) {
        ...
        if (timer.isRunning) {
          ...
          toggleText.textContent = timer.remainingSeconds < timer.totalSeconds && timer.remainingSeconds > 0 ? lang === "ar" ? "\u0627\u0633\u062A\u0626\u0646\u0627\u0641" : "Resume" : I18n.t("recipe.timer_start");
    ...
    static renderChefNotes() {
      ...
      if (tips.length > 0) {
        ...
        const defaultNote = lang === "ar" ? "\u0627\u062D\u0631\u0635 \u062F\u0627\u0626\u0645\u0627\u064B \u0639\u0644\u0649 \u0627\u0633\u062A\u062E\u062F\u0627\u0645 \u0645\u0643\u0648\u0646\u0627\u062A \u0637\u0627\u0632\u062C\u0629 \u0639\u0627\u0644\u064A\u0629 \u0627\u0644\u062C\u0648\u062F\u0629 \u0648\u0636\u0628\u0637 \u062F\u0631\u062C\u0627\u062A \u0627\u0644\u062D\u0631\u0627\u0631\u0629 \u0628\u062F\u0642\u0629 \u0644\u0644\u062D\u0635\u0648\u0644 \u0639\u0644\u0649 \u0642\u0648\u0627\u0645 \u0648\u0646\u0643\u0647\u0629 \u0645\u062B\u0627\u0644\u064A\u0629." : "Always ensure high-quality fresh ingredients and precise temperature management for ideal taste and texture.";
  ...
  var CreateRecipeStudio = class {
    ...
    static goToStep(stepNumber) {
      ...
      if (stepText) {
        ...
        stepText.textContent = isAr ? `\u0627\u0644\u0645\u0631\u062D\u0644\u0629 ${targetStep} \u0645\u0646 ${this.totalSteps}` : `Step ${targetStep} of ${this.totalSteps}`;
      }
    ...
    static addIngredientRow(data = {}) {
      ...
      <div class="md:col-span-2 space-y-1 text-start">
        ...
        <input type="number" step="any" min="0.01" class="ingredient-qty w-full px-3 py-1.5 text-xs font-bold text-center bg-surface-1 border border-border-subtle rounded-lg text-text-main focus:outline-none focus:ring-1 focus:ring-brand-gold"
               placeholder="100" value="${data.baseAmount !== void 0 ? data.baseAmount : data.amount || 100}" required>
      </div>
        ...
        <div class="sm:col-span-3 space-y-1">
          ...
          <div class="flex items-center gap-1.5">
            ...
            <input type="number" min="0" max="600" class="step-timer-minutes w-full px-2.5 py-1.5 text-xs font-bold text-center bg-surface-1 border border-border-subtle rounded-lg text-text-main focus:outline-none focus:ring-1 focus:ring-brand-gold"
                   placeholder="10" value="${data.timer_minutes !== void 0 ? data.timer_minutes : 10}">
          </div>
        </div>
  ...
  __publicField(CreateRecipeStudio, "SECTIONS", [
  ...
  __publicField(CreateRecipeStudio, "currentStep", 1);
  __publicField(CreateRecipeStudio, "totalSteps", 4);
  __publicField(CreateRecipeStudio, "coverImage", "");
  ...
  var ChefPage = class {
    ...
    static renderProfileHeader() {
      ...
      if (followersCount) followersCount.textContent = chef.followers_formatted || `${(chef.followers / 1e3).toFixed(1)}k`;
    ...
    static renderRecipesPanel() {
      ...
      if (counterText) {
        counterText.textContent = isAr ? `${recipes.length} \u0648\u0635\u0641\u0629 \u0645\u062A\u0627\u062D\u0629` : `${recipes.length} Recipes Available`;
      }
      if (recipes.length === 0) {
        grid.innerHTML = "";
    ...
    static renderPortfolioPanel() {
      ...
      grid.innerHTML = dishes.map((dish, idx) => {
        ...
        <article class="bg-surface-1 border border-border-subtle rounded-3xl overflow-hidden shadow-sm hover:border-border-subtle transition-all flex flex-col justify-between text-start">
          <div class="space-y-4">
            ...
            <div class="relative h-64 sm:h-72 w-full overflow-hidden bg-surface-2">
              ...
              <div class="absolute bottom-4 end-4">
                ${hasRecipe ? `<span class="px-3 py-1.5 rounded-xl bg-brand-emerald text-white text-xs font-bold shadow-md flex items-center gap-1.5">
                    ...
                    </span>` : `<span class="px-3 py-1.5 rounded-xl bg-surface-1 border border-border-subtle text-text-muted text-xs font-semibold shadow-md">
            ...
            <div class="p-6 space-y-3">
              ...
              <p class="text-xs sm:text-sm text-text-muted leading-relaxed font-normal">
                ${isAr ? "\u0637\u0628\u0642 \u062A\u0648\u0642\u064A\u0639 \u0627\u0633\u062A\u062B\u0646\u0627\u0626\u064A \u064A\u062C\u0645\u0639 \u0628\u064A\u0646 \u062F\u0642\u0629 \u062A\u0642\u0646\u064A\u0627\u062A \u0627\u0644\u0637\u0647\u064A \u0627\u0644\u062C\u0632\u064A\u0626\u064A \u0648\u0627\u0644\u0625\u0646\u0636\u0627\u062C \u0627\u0644\u062D\u0631\u0641\u064A \u0645\u0639 \u0645\u0643\u0648\u0646\u0627\u062A \u0645\u062D\u0644\u064A\u0629 \u0645\u0633\u062A\u062F\u0627\u0645\u0629 \u0648\u0646\u0643\u0647\u0627\u062A \u0645\u0639\u062A\u0642\u0629." : "An exemplary signature creation marrying molecular precision with heritage-aged terroir and sustainably sourced artisanal ingredients."}
              </p>
            </div>
          </div>
          ...
          <!-- Bottom Action -->
          <div class="p-6 pt-0">
            ${hasRecipe ? `<a href="recipe.html?id=${dish.recipe_id}"
                  ...
                  <svg class="w-4 h-4 rtl:rotate-180" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m9 18 6-6-6-6"/></svg>
                </a>` : `<div class="p-3 rounded-xl bg-surface-2 border border-border-subtle text-center text-xs text-text-muted">
        ...
        <article class="group bg-surface-1 border border-border-subtle rounded-3xl overflow-hidden shadow-sm hover:border-border-subtle transition-all flex flex-col justify-between text-start">
          <div>
            ...
            <div class="p-5 space-y-2">
              ...
              <p class="text-xs text-text-muted line-clamp-2 leading-relaxed">
                ${isAr ? "\u0645\u062C\u0645\u0648\u0639\u0629 \u0648\u0635\u0641\u0627\u062A \u0648\u062A\u0643\u0646\u064A\u0643\u0627\u062A \u0645\u062E\u062A\u0627\u0631\u0629 \u0628\u0639\u0646\u0627\u064A\u0629 \u0644\u0644\u0645\u0637\u0627\u0628\u062E \u0627\u0644\u0627\u062D\u062A\u0631\u0627\u0641\u064A\u0629 \u0648\u0627\u0644\u0637\u0647\u064A \u0627\u0644\u0627\u0628\u062A\u0643\u0627\u0631\u064A." : "Curated collection of culinary blueprints and techniques for professional kitchens."}
              </p>
            </div>
          </div>
    ...
    static renderAboutPanel() {
      ...
      if (bioFull) {
        bioFull.textContent = isAr ? `${chef.bio_ar} \u064A\u0645\u062A\u0644\u0643 \u062E\u0628\u0631\u0629 \u062A\u062A\u062C\u0627\u0648\u0632 ${chef.experience_years} \u0639\u0627\u0645\u0627\u064B \u0641\u064A \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u0637\u0627\u0628\u062E \u0627\u0644\u0641\u0646\u062F\u0642\u064A\u0629 \u0627\u0644\u0641\u0627\u062E\u0631\u0629 \u0648\u062A\u0637\u0648\u064A\u0631 \u0642\u0648\u0627\u0626\u0645 \u0627\u0644\u0637\u0639\u0627\u0645 \u0627\u0644\u062A\u062C\u0631\u064A\u0628\u064A\u0629 \u0648\u062A\u062F\u0631\u064A\u0628 \u0623\u062C\u064A\u0627\u0644 \u0645\u0646 \u0627\u0644\u0637\u0647\u0627\u0629 \u0627\u0644\u0648\u0627\u0639\u062F\u064A\u0646 \u0639\u0644\u0649 \u0623\u0639\u0644\u0649 \u0627\u0644\u0645\u0639\u0627\u064A\u064A\u0631 \u0627\u0644\u0639\u0627\u0644\u0645\u064A\u0629.` : `${chef.bio_en} Bringing over ${chef.experience_years} years of elite fine dining brigade leadership, experimental menu curation, and master mentorship aligned with the world's most rigorous culinary standards.`;
      }
    ...
    static copyShareUrl() {
      ...
      if (navigator && navigator.clipboard && navigator.clipboard.writeText) {
        navigator.clipboard.writeText(url).then(() => Toast.success(I18n.t("toast.copied_success"))).catch(() => Toast.success(I18n.t("toast.copied_success")));
      } else {
        const shareInput = document.getElementById("chef-share-url-input");
        if (shareInput) {
          shareInput.select();
  ...
  var DashboardPage = class {
    ...
    static renderTrafficChart() {
      ...
      const maxVal = Math.max(...points.map((p) => Math.max(p.views, p.impressions)), 1e3);
      ...
      <svg viewBox="0 0 ${width} ${height}" class="w-full h-full" preserveAspectRatio="none">
        ...
        ${gridLines.map((g) => `
          ...
          <text x="${paddingStart - 10}" y="${g.y + 4}" font-size="10" fill="${textColor}" text-anchor="end" font-family="monospace">${g.val >= 1e3 ? (g.val / 1e3).toFixed(0) + "k" : g.val}</text>
        `).join("")}
    ...
    static renderRevenueChart() {
      ...
      const chartW = width - paddingStart - paddingEnd;
      const chartH = height - paddingTop - paddingBottom;
      const maxRev = Math.max(...points.map((p) => p.revenue), 1e4);
    ...
    static renderTable() {
      ...
      if (summary) {
        if (totalItems === 0) {
          ...
          summary.textContent = isAr ? `\u0639\u0631\u0636 ${from}-${to} \u0645\u0646 \u0625\u062C\u0645\u0627\u0644\u064A ${totalItems} \u0639\u0646\u0635\u0631` : `Showing ${from}-${to} of ${totalItems} items`;
        }
      }
        ...
        <tbody class="divide-y divide-border-subtle">
          ${items.map((r) => `
            <tr class="hover:bg-surface-2 transition-colors">
              ...
              <td class="py-3 px-4 text-start">
                ${r.status === "published" ? `<span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-surface-2 text-brand-emerald border border-border-subtle"><span class="w-1.5 h-1.5 rounded-full bg-brand-emerald"></span> ${isAr ? "\u0645\u0646\u0634\u0648\u0631\u0629" : "Published"}</span>` : `<span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-surface-2 text-amber-500 border border-amber-500"><span class="w-1.5 h-1.5 rounded-full bg-amber-500"></span> ${isAr ? "\u0645\u0633\u0648\u062F\u0629" : "Draft"}</span>`}
              </td>
        ...
        <tbody class="divide-y divide-border-subtle">
          ${items.map((s) => `
            <tr class="hover:bg-surface-2 transition-colors">
              ...
              <td class="py-3 px-4 text-start">
                ${s.stock_status === "low_stock" ? `<span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-surface-2 text-amber-500 border border-amber-500">${isAr ? `\u0645\u062E\u0632\u0648\u0646 \u0645\u0646\u062E\u0641\u0636 (${s.stock_count})` : `Low Stock (${s.stock_count})`}</span>` : s.stock_status === "out_of_stock" ? `<span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-surface-2 text-red-500 border border-red-500">${isAr ? "\u0646\u0641\u062F \u0627\u0644\u0645\u062E\u0632\u0648\u0646" : "Out of Stock"}</span>` : `<span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-surface-2 text-brand-emerald border border-border-subtle">${isAr ? `\u0645\u062A\u0648\u0641\u0631 (${s.stock_count})` : `In Stock (${s.stock_count})`}</span>`}
              </td>
              <td class="py-3 px-4 text-start font-mono font-bold text-text-main">
                ${s.inquiries} ${isAr ? "\u0637\u0644\u0628" : "inquiries"}
              </td>
              <td class="py-3 px-4 text-start">
                ${s.status === "active" ? `<span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-surface-2 text-brand-emerald border border-border-subtle"><span class="w-1.5 h-1.5 rounded-full bg-brand-emerald"></span> ${isAr ? "\u0646\u0634\u0637" : "Active"}</span>` : `<span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-surface-2 text-text-muted border border-border-subtle"><span class="w-1.5 h-1.5 rounded-full bg-text-muted"></span> ${isAr ? "\u0645\u062A\u0648\u0642\u0641" : "Paused"}</span>`}
              </td>
              <td class="py-3 px-4 text-end">
                <div class="flex items-center justify-end gap-1.5">
        ...
        <tbody class="divide-y divide-border-subtle">
          ${items.map((rfq) => `
            <tr class="hover:bg-surface-2 transition-colors">
              ...
              <td class="py-3 px-4 text-start font-mono">
                ${rfq.quoted_price ? `<span class="font-bold text-brand-emerald">${rfq.quoted_price.toLocaleString()} ${isAr ? "\u0631.\u0633" : "SAR"}</span>` : `<span class="text-text-muted italic">${isAr ? "\u0628\u0627\u0646\u062A\u0638\u0627\u0631 \u0627\u0644\u062A\u0633\u0639\u064A\u0631" : "Awaiting Quote"}</span>`}
              </td>
              <td class="py-3 px-4 text-start">
                ${rfq.status === "pending" ? `<span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-surface-2 text-amber-500 border border-amber-500">${isAr ? "\u0642\u064A\u062F \u0627\u0644\u0645\u0631\u0627\u062C\u0639\u0629" : "Pending Review"}</span>` : rfq.status === "quoted" ? `<span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-surface-2 text-blue-500 border border-blue-500">${isAr ? "\u062A\u0645 \u062A\u0642\u062F\u064A\u0645 \u0627\u0644\u0639\u0631\u0636" : "Quotation Sent"}</span>` : rfq.status === "accepted" ? `<span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-surface-2 text-brand-emerald border border-border-subtle">${isAr ? "\u0645\u0642\u0628\u0648\u0644 \u0648\u0645\u0624\u0643\u062F" : "Accepted"}</span>` : `<span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-surface-2 text-red-500 border border-red-500">${isAr ? "\u0645\u0631\u0641\u0648\u0636" : "Declined"}</span>`}
              </td>
              <td class="py-3 px-4 text-end">
                <div class="flex items-center justify-end gap-1.5">
    ...
    static handleAddSupplySubmit(form) {
      ...
      const price = parseFloat(priceInput ? priceInput.value : "0") || 1e3;
  ...
  // 'recipes' | 'supplies' | 'rfqs' | 'enrollments'
  __publicField(DashboardPage, "searchQuery", "");
  __publicField(DashboardPage, "statusFilter", "all");
  ...
  var SuppliesPage = class {
    ...
    `).join("");
      const stockBadge = item.in_stock ? `<span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold bg-surface-2 text-brand-emerald border border-border-subtle shadow-sm">
           <span class="w-1.5 h-1.5 rounded-full bg-brand-emerald animate-pulse"></span>
           ${I18n.t("supplies.in_stock")} (${item.stock_count} ${unit})
         </span>` : `<span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold bg-surface-2 text-red-500 border border-red-500">
  ...
  // all | 1 | 2 | 5 | 10+
  __publicField(SuppliesPage, "stockFilter", "all");
  // all | in_stock
  __publicField(SuppliesPage, "selectedCertifications", /* @__PURE__ */ new Set());
  __publicField(SuppliesPage, "minPrice", null);
  __publicField(SuppliesPage, "maxPrice", null);
  ...
  var CoursesPage = class {
    ...
    static renderCourseCard(course, isAr) {
      ...
      const seatsBadgeClass = isUrgent ? "bg-surface-2 text-red-500 border-red-500" : "bg-surface-2 text-text-muted border-border-subtle";
    ...
    static render() {
      ...
      if (countLabel) {
        ...
        countLabel.textContent = isAr ? `\u0639\u0631\u0636 ${count} \u0648\u0631\u0634\u0629 \u0639\u0645\u0644 \u0645\u0639\u062A\u0645\u062F\u0629` : `Showing ${count} accredited masterclasses`;
      }
  ...
  // all | masterclass | intermediate | beginner
  __publicField(CoursesPage, "searchQuery", "");
  __publicField(CoursesPage, "sortBy", "popular");
  ...
  var ChatModule = class {
    ...
    static filterChats(category = "all", query = "") {
      ...
      if (query && query.trim()) {
        ...
        chats = chats.filter((c) => {
          ...
          const hasMsgMatch = c.messages?.some(
            (m) => normalizeSearchQuery(m.text_ar || "").includes(norm) || normalizeSearchQuery(m.text_en || "").includes(norm)
          );
          return nameAr.includes(norm) || nameEn.includes(norm) || lastAr.includes(norm) || lastEn.includes(norm) || itemAr.includes(norm) || itemEn.includes(norm) || hasMsgMatch;
        });
      }
      return chats;
    }
     ...
     */
    static simulatePartnerReply(chatId, userMessageText = "", delayMs = 1e3) {
  ...
  var ChatPage = class {
    ...
    static renderConversationList() {
      ...
      listEl.innerHTML = chats.map((chat) => {
        ...
        const roleLabel = chat.partner?.role === "supplier" ? isAr ? "\u0645\u0648\u0631\u062F" : "Supplier" : isAr ? "\u0634\u064A\u0641" : "Chef";
        const unreadCount = chat.unread_count || 0;
        const hasRFQ = Boolean(chat.rfq_card);
        const activeClasses = isActive ? "bg-surface-2 border-s-4 border-s-brand-gold text-text-main shadow-xs" : "bg-surface-1 hover:bg-surface-2 text-text-muted hover:text-text-main border-s-4 border-s-transparent";
        return `
    ...
    static handleSendMessage() {
      ...
      ChatModule.simulatePartnerReply(this.activeChatId, text, 1e3).then(() => {
    ...
    static handleApproveQuote(chatId, rfqId) {
      ...
      ChatModule.simulatePartnerReply(chatId, "\u0642\u0628\u0648\u0644 \u0627\u0644\u0639\u0631\u0636", 1e3).then(() => {
        if (typingEl) typingEl.classList.add("hidden");
        this.renderConversationList();
        this.renderActiveThread();
      });
    ...
    static handleOpenCounterModal(chatId, rfqId) {
      ...
      const suggestedPrice = Math.round(Number(rfq.unit_price || 1e3) * 0.9);
    ...
    static handleSubmitCounterOffer() {
      ...
      ChatModule.simulatePartnerReply(chatId, "\u0639\u0631\u0636 \u0645\u0642\u0627\u0628\u0644", 1e3).then(() => {
        if (typingEl) typingEl.classList.add("hidden");
        this.renderConversationList();
        this.renderActiveThread();
      });
  ...
  __publicField(ChatPage, "activeChatId", null);
  __publicField(ChatPage, "currentCategory", "all");
  // all | chef | supplier
  __publicField(ChatPage, "searchQuery", "");
  ...
  var NotificationsPage = class {
    ...
    static toggleRead(id) {
      ...
      item.read = !item.read;
      this.saveNotifications(items, true);
      const msg = item.read ? I18n.t("notifications.mark_read") : I18n.t("notifications.mark_unread");
      Toast.info(msg);
    }
    /**
    ...
    static renderCard(notif, lang) {
      ...
      const unreadIndicator = isUnread ? `<span class="w-2.5 h-2.5 rounded-full bg-brand-gold shrink-0 ring-4 ring-brand-gold/20" title="${I18n.t("notifications.unread")}"></span>` : "";
